 ...
 * It extends the Appointment class to hold additional data specific to imaging appointments,
...
public class Imaging extends Appointment {
     ...
     * @param room      The imaging room for the appointment (CATSCAN, ULTRASOUND, or XRAY).
     */
